...
<!-- Mirrored from themesbrand.com/velzon/html/master/auth-lockscreen-cover.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Aug 2024 07:46:59 GMT -->
<head>

    <meta charset="utf-8" />
    <title>Écran verrouillé | Administration C.S.P.P.UNILU</title>
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        ...
                                        <div class="user-thumb text-center">
                                            ...
                                            <h5 class="mt-3">Administration</h5>
                                        </div>
                                        ...
                                        <div class="mt-4">
                                            <form>
                                                <div class="mb-3">
                                                    ...
                                                    <input type="password" class="form-control" id="userpassword" placeholder="Entrez le mot de passe" required>
                                                </div>
                                                <div class="mb-2 mt-4">
                                        ...
                                        <div class="mt-5 text-center">
                                            <p class="mb-0">Pas vous ? retournez à <a href="auth-signin-cover.php" class="fw-semibold text-primary text-decoration-underline"> Connexion</a></p>
                                        </div>
                                    </div>
                                </div>
                                <!-- end col -->
